...
<body>
  <div class="site-container">
    ...
    <!-- Playlist Catalog Toolbar (Cards / List Selector) -->
    <div class="view-toggle-toolbar" style="margin-bottom: 1.5rem;">
      <span class="track-count-badge">${slugs.length} playlist${slugs.length > 1 ? 's' : ''}</span>
    ...
    <!-- Playlist Catalog -->
    <main>
      <div class="playlists-catalog-grid" id="catalog-grid">
        ${playlistCardsHTML}
      </div>
    </main>
  </div>
